...
Version  : 2.8.1
Release  : 19
URL      : https://files.pythonhosted.org/packages/ed/e2/529126c23c686968ac6223fa0451ef0517a0dc5bf59d49687bfed3865d91/netdisco-2.8.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ed/e2/529126c23c686968ac6223fa0451ef0517a0dc5bf59d49687bfed3865d91/netdisco-2.8.1.tar.gz
...
%prep
%setup -q -n netdisco-2.8.1
cd %{_builddir}/netdisco-2.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595865649
...
cp %{_builddir}/netdisco-2.8.1/LICENSE.md %{buildroot}/usr/share/package-licenses/netdisco/4a606a34022a7ef2eab88e43148dd48547d3c017
