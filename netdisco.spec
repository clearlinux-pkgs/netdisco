...
Source0  : https://files.pythonhosted.org/packages/a8/4a/aaa15b62f303e935f68b09fd904835fa92e3e9d32205bc41b11e8a2fcbb8/netdisco-2.8.2.tar.gz
...
%prep
%setup -q -n netdisco-2.8.2
cd %{_builddir}/netdisco-2.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597678181
...
cp %{_builddir}/netdisco-2.8.2/LICENSE.md %{buildroot}/usr/share/package-licenses/netdisco/4a606a34022a7ef2eab88e43148dd48547d3c017
