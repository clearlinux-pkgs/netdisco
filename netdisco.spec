...
Source0  : https://files.pythonhosted.org/packages/64/ec/07a78d7704abcdd2e8aca70595375f29dfb76b32aa281f529b7806479c97/netdisco-2.9.0.tar.gz
...
%prep
%setup -q -n netdisco-2.9.0
cd %{_builddir}/netdisco-2.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624460177
...
cp %{_builddir}/netdisco-2.9.0/LICENSE.md %{buildroot}/usr/share/package-licenses/netdisco/4a606a34022a7ef2eab88e43148dd48547d3c017
